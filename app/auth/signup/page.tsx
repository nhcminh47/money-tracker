    ...
    return (
      <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-coral-300 via-coral-200 to-coral-100 px-4'>
        <div className='max-w-md w-full'>
          <div className='bg-white rounded-card shadow-card-hover p-8 text-center'>
            <div className='text-6xl mb-4'>✅</div>
            <h1 className='text-3xl font-bold text-gray-900 mb-4'>{t.auth?.checkEmail || 'Check your email'}</h1>
            ...
            <Link href='/auth/login'>
              <Button className='w-full'>{t.auth?.backToLogin || 'Back to Login'}</Button>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className='max-w-md w-full'>
        <div className='bg-white rounded-card shadow-card-hover p-8'>
          <div className='text-center mb-8'>
            <div className='text-6xl mb-4'>💰</div>
            <h1 className='text-3xl font-bold text-gray-900 mb-2'>{t.auth?.createAccount || 'Create Account'}</h1>
            <p className='text-gray-600'>{t.auth?.signupSubtitle || 'Start tracking your money'}</p>
          </div>
