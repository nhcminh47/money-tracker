...
async function seedDemoTransactions(categories: Category[]): Promise<Transaction[]> {
  ...
  const expenseData = [
    { category: 'Food & Dining', amounts: [120, 85, 95, 110, 78, 92], notes: 'Weekly groceries', recurring: false },
    { category: 'Food & Dining', amounts: [45, 67, 52, 38, 71], notes: 'Dining out', recurring: false },
    { category: 'Transportation', amounts: [60, 55, 58], notes: 'Gas and parking', recurring: false },
    { category: 'Bills & Utilities', amounts: [150, 145], notes: 'Monthly utilities', recurring: true },
    ...
    { category: 'Other Expense', amounts: [299], notes: 'Online course subscription', recurring: true },
  ]
