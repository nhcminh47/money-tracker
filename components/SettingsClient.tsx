...
import { seedDemoData, clearDemoData, hasDemoData } from '@/lib/utils/demoData';
...
export default function SettingsClient() {
  ...
  async function handleSettingChange<K extends keyof Omit<AppSettings, 'id' | 'updatedAt'>>(
    key: K,
    value: AppSettings[K]
  ) {
    try {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm bg-sky-100 text-sky-800 px-2 py-1 rounded">{t.settings.pwaType}</span>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card>
        <div className="p-6">
          ...
          <div className="space-y-2">
            ...
            <Button variant="secondary" onClick={() => setShowExportModal(true)} className="w-full justify-start">
              <span className="mr-2">🔒</span>
            ...
            <Button variant="secondary" onClick={() => setShowImportModal(true)} className="w-full justify-start">
              <span className="mr-2">📤</span>
      ...
      <Card>
        <div className="p-6">
          <h3 className="text-lg font-semibold mb-4">{t.settings.demoData}</h3>
