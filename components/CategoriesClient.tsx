...
const PRESET_COLORS = [
  '#ef4444', '#f59e0b', '#f97316', '#84cc16', '#22c55e', '#10b981',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between pl-14 md:pl-0">
        ...
        <Button onClick={openCreateModal} className="hidden md:inline-flex">{t.categories?.createCategory || 'Add Category'}</Button>
      </div>
              ...
              <div className="space-y-3">
                ...
                {stats[category.id] && (
                  <div className="text-sm text-gray-600 space-y-1">
                    <p>{stats[category.id].transactionCount} {t.categories?.transactions || 'transactions'}</p>
                    <p className="font-medium">
                      {formatCurrency(stats[category.id].totalAmount, settings?.currency)}
                    </p>
                  </div>
                )}
